...
namespace GMKB.Models
{
    ...
    public partial class McM_ProductTab
    {
        ...
        public string McM_BankName { get; set; }
        public string McM_BankNumber { get; set; }
        public string McM_BillPayID { get; set; }
        public string McM_csi_number { get; set; }
    }
}
